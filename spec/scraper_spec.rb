...
describe "Scraper" do
    ...
    let!(:anime_array) {[
        ...
        {:genre=>"Thriller", :anime=>[ #this one includes synopses!!!!!!!
            {:name=>"Death Note", :genres=>["Mystery", "Police", "Psychological", "Supernatural", "Thriller", "Shounen"], :synopsis=>death_note_synopsis},
            {:name=>"Steins;Gate", :genres=>["Thriller", "Sci-Fi"], :synopsis=>steins_gate_synopsis},
            {:name=>"Mirai Nikki", :genres=>["Action", "Mystery", "Psychological", "Shounen", "Supernatural", "Thriller"], :synopsis=>mirai_synopsis},
            {:name=>"Re:Zero kara Hajimeru Isekai Seikatsu", :genres=>["Psychological", "Drama", "Thriller", "Fantasy"], :synopsis=>re_zero_synopsis},
